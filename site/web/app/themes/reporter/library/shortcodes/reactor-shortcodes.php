...
class ReactorShortcodes {
    ...
    {	
    	...
    	define('REACTOR_TINYMCE_URI', get_template_directory_uri() . '/library/shortcodes/tinymce');
		define('REACTOR_TINYMCE_DIR', get_template_directory_uri() . '/library/shortcodes/tinymce');
	...
	function init()
	{
		if( is_admin() )
		{
			...
			wp_enqueue_script( 'reactor-shortcodes-lib', get_template_directory_uri() . '/library/shortcodes/js/reactor-shortcodes-lib.js', array('jquery', 'jquery-ui-accordion', 'jquery-ui-tabs') );
		}
	...
	function admin_init()
	{
		...
		wp_localize_script( 'jquery', 'ReactorShortcodes', array('theme_folder' => get_template_directory_uri() . '/library/shortcodes') );
	}
