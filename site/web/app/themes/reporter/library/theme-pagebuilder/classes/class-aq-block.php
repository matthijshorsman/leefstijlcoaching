...
if(!class_exists('AQ_Block')) {
	class AQ_Block {
	 	...
	 	function before_block($instance) {
	 		...
	 		//print_r($instance);
	 		if( $size == 'span1' ) $size = 'large-1';
	 		if( $size == 'span2' ) $size = 'large-2';
	 		if( $size == 'span3' ) $size = 'large-3';
	 		if( $size == 'span4' ) $size = 'large-4';
	 		if( $size == 'span5' ) $size = 'large-5';
	 		if( $size == 'span6' ) $size = 'large-6';
	 		if( $size == 'span7' ) $size = 'large-7';
	 		if( $size == 'span8' ) $size = 'large-8';
			if( $size == 'span9' ) $size = 'large-9';
			if( $size == 'span10' ) $size = 'large-10';
			if( $size == 'span11' ) $size = 'large-11';
			if( $size == 'span12' ) $size = 'large-12';



	 			echo '<div id="engine-block-'.$template_id.'-'.$number.'" class="'.$size.' small-12 engine-block column block-'.$name.'">';
