...
function cmb_sample_metaboxes( array $meta_boxes ) {
	...
	$post_sidebar_pos = 'right';
	if( isset($reporter_data['post_sidebar_pos']) ) $post_sidebar_pos = $reporter_data['post_sidebar_pos'];

	$page_sidebar_pos = 'left';
	if( isset($reporter_data['page_sidebar_pos']) ) $page_sidebar_pos = $reporter_data['page_sidebar_pos'];
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'desc' => __('Select a position for the sidebar or remove it.','engine'),
				'id' => $prefix . 'sidebar_pos',
				'type' => 'select',
				'std' => $post_sidebar_pos,
				'options' => array(
					array('value' => 'right-sidebar', 'name' => __('Right','engine') ),
					array('value' => 'left-sidebar', 'name' => __('Left','engine') ),
					array('value' => 'no-sidebar', 'name' => __('No Sidebar','engine') )
				)
			)
		)
	...
	/*$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array( 'id' => 'input', 'name' => 'A Normal text input', 'type' => 'text', 'cols' => 12, 'readonly' => false ),
